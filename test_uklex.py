config = {
    'dataset': 'uklex69', # choices=['arxiv', 'drug', 'huffpost', 'mimic', 'fmow', 'yearbook']
    'method': 'irm', # choices=['er', 'coral', 'ensemble', 'ewc', 'ft', 'groupdro', 'irm', 'si', 'erm', 'simclr', 'swav', 'swa']
    'device': 3,  # 'gpu id'
    ...
    'train_update_iter': 1,  # 'train update iter'
    ...
    'split_time': 2012,  # 'timestep to split ID vs OOD'
    'test_time': 2012,
    ...
    # GroupDRO
    'num_groups': 5,  # 'number of windows for Invariant Learning baselines'
    'group_size': 3,  # 'window size for Invariant Learning baselines'
